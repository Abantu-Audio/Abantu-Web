...
export default function MembershipPage() {
  return (
    <div className="min-h-full flex flex-col bg-[#121418] justify-center items-center">
      {/* Header Section */}
        ...
        <Card className="p-6 bg-white/5 backdrop-blur-lg border-0">
          <div className="space-y-10">
            <div className="space-y-1">
              <h2 className="text-xl text-[#724EEA] font-armin font-bold">Abantu Pro</h2>
              <p className="text-sm text-white font-armin font-regular">Auto renews at $14.99/month</p>
            </div>
            ...
            <div className="space-y-3">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <span className="text-white text-sm font-armin font-semibold">{benefit}</span>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-6">
              <p className="text-xs text-gray-300 font-armin font-normal">
              ...
              <Button 
                className="w-full h-[50px] text-white bg-[#724EEA] hover:opacity-90 rounded-full font-armin font-semibold"
              >
